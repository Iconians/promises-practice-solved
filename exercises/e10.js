...
// Your code goes here...
export const handlePromise2 = () => Promise.any(promiseArr).then((val) => val);
...
export const handlePromise3 = () =>
  Promise.allSettled(promiseArr).then((val) => val.map((el) => el));
/**
 * @task
...
export const newPromiseArr = promiseArr.filter((el) => el !== promise3);
